                ...
                <nav className="inline-flex rounded-md shadow">
                    ...
                    {startPage > 1 && (
                        <>
                            ...
                            {startPage > 2 && <span className="px-3 py-1 border-t border-b border-gray-300 bg-white">...</span>}
                        </>
                    )}
                    ...
                    {endPage < totalPages && (
                        <>
                            {endPage < totalPages - 1 && <span className="px-3 py-1 border-t border-b border-gray-300 bg-white">...</span>}
                            <button
                                        ...
                                        {currentItems.map((product) => (
                                            ...
                                            >
                                                ...
                                                <div className="p-4 border-t flex-grow flex flex-col">
                                                    ...
                                                    <h4 className="text-center text-gray-500 font-medium mb-1">
                                                        <span className='font-bold text-gray-700'>Brand:</span> {product.brand?.name || 'N/A'}
                                                    </h4>
